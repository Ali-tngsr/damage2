...
def run_pipeline(L=70.0, t_0=0.25, t_90=0.5, rho_sat=8.0, seed=42,
    ...
    if cohesive_mode == 'manual':
        print()
        print('=' * 70)
        print('MANUAL COHESIVE INSERTION REQUIRED')
        print('=' * 70)
        print()
        print('The .cae file has been saved with geometry, mesh, and edge')
        print('sets — but NO cohesive elements yet.')
        print()
        print('NEXT STEPS:')
        print()
        ...
        print()
        print('  2. Insert cohesive elements manually.')
        print('     Follow MANUAL_COHESIVE_WORKFLOW.md step-by-step.')
        print('     Estimated time: ~15 minutes per job.')
        print()
        print('  3. Save the .cae file (File > Save).')
        print()
